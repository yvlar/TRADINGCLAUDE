...
**Version** : 10.34.0
**Tests** : 1 716 backend collectés (1 716 passés, 3 skipped, 1 xfailed — +2) ; `ruff All checks passed` ; `mypy app/` 0 erreur (149 fichiers) ; frontend inchangé (sprint backend pur).
